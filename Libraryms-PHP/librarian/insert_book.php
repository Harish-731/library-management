					...
					<p class="cd-select icon">
						<select class="b-category" name="b_category">
							...
							<option>Literature</option>
                                ...
                                <div class="icon">
					<input class="b-location" type="text" name="b_location" placeholder="Book Location" required />
				</div>
	...
	<?php
		if(isset($_POST['b_add']))
		{
			...
			else
			{
				...
				$query->bind_param("sssssdd", $_POST['b_isbn'], $_POST['b_title'], $_POST['b_author'], $_POST['b_category'], $_POST['b_location'], $_POST['b_price'], $_POST['b_copies']);
