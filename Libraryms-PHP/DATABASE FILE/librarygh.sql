...
INSERT INTO `book` (`isbn`, `title`, `author`, `category`, `location`, `price`, `copies`) VALUES
('6900152484440', 'V for Vendetta', 'Alan Moore', 'Comics', 'Chennai', 299, 13),
('9782616052277', 'X-Men: God Loves, Man Kills', 'Chris', 'Comics', 'Coimbatore', 399, 33),
('9783161484100', 'Mike Tyson : Undisputed Truth', 'Larry Sloman, Mike Tyson', 'Sports', 'Chennai', 299, 19),
('9789996245442', 'When Breath Becomes Air', 'Paul Kalanithi', 'Medical', 'Coimbatore', 515, 9),
('9885691200700', 'The Great Gatsby', 'F. Scott Fitzgerald', 'Fiction', 'Chennai', 420, 20);
